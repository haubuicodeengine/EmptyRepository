...
<div class="container-fluid-1280">
	...
	<clay:management-toolbar disabled="${courseCount eq 0}" displayContext="${coursesManagementToolbarDisplayContext}"
	itemsTotal="${courseCount}" searchContainerId="courseEntries" selectable="false" />
