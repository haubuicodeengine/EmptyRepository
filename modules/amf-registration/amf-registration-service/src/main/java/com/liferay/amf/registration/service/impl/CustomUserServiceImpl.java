 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>com.liferay.amf.registration.service.CustomUserService</code> interface.
 *
 * <p>
...
public class CustomUserServiceImpl extends CustomUserServiceBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Always use <code>com.liferay.amf.registration.service.CustomUserServiceUtil</code> to access the custom user remote service.
	 */
}