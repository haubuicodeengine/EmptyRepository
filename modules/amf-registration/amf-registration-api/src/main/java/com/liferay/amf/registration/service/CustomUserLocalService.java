...
public interface CustomUserLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CustomUserLocalServiceUtil} to access the custom user local service. Add custom service methods to <code>com.liferay.amf.registration.service.impl.CustomUserLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
