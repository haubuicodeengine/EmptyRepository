...
public interface ArticleLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.amf.newsletter.service.impl.ArticleLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the article local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ArticleLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Article createArticle(long resourcePrimKey);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Article deleteArticle(long resourcePrimKey) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Article fetchArticle(long resourcePrimKey);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Article getArticle(long resourcePrimKey) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Article> getArticlesByUuidAndCompanyId(
