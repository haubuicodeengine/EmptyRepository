...
/**
 * The extended model interface for the Newsletter service. Represents a row in the &quot;TS_Newsletter&quot; database table, with each column mapped to a property of this class.
 *
...
public interface Newsletter extends NewsletterModel, PersistedModel {
	 ...
	 */
	public static final Accessor<Newsletter, Long> RESOURCE_PRIM_KEY_ACCESSOR =
		new Accessor<Newsletter, Long>() {

			@Override
			public Long get(Newsletter newsletter) {
				return newsletter.getResourcePrimKey();
			}
