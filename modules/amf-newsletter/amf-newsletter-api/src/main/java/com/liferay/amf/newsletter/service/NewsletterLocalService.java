...
public interface NewsletterLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.amf.newsletter.service.impl.NewsletterLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the newsletter local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NewsletterLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Newsletter createNewsletter(long resourcePrimKey);
	...
	public Newsletter deleteNewsletter(long resourcePrimKey)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Newsletter fetchNewsletter(long resourcePrimKey);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Newsletter fetchNewsletterByUuidAndGroupId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Newsletter getNewsletter(long resourcePrimKey)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Newsletter getNewsletterByUuidAndGroupId(String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Newsletter> getNewslettersByUuidAndCompanyId(
