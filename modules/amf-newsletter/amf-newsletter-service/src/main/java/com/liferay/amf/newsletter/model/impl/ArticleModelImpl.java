...
/**
 * The base model implementation for the Article service. Represents a row in the &quot;TS_Article&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class ArticleModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "TS_Article";
	...
	public static final String TABLE_SQL_CREATE =
		"create table TS_Article (uuid_ VARCHAR(75) null,resourcePrimKey LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,issueNumber LONG)";

	public static final String TABLE_SQL_DROP = "drop table TS_Article";

	public static final String ORDER_BY_JPQL =
		" ORDER BY article.issueNumber ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY TS_Article.issueNumber ASC";
	...
	static {
		...
		attributeSetterBiConsumers.put(
			"resourcePrimKey",
			(BiConsumer<Article, Long>)Article::setResourcePrimKey);
		...
		attributeGetterFunctions.put("userId", Article::getUserId);
		attributeSetterBiConsumers.put(
			"userId", (BiConsumer<Article, Long>)Article::setUserId);
		attributeGetterFunctions.put("userName", Article::getUserName);
		attributeSetterBiConsumers.put(
			"userName", (BiConsumer<Article, String>)Article::setUserName);
	...
	public int compareTo(Article article) {
		...
		if (getIssueNumber() < article.getIssueNumber()) {
			value = -1;
		}
		else if (getIssueNumber() > article.getIssueNumber()) {
			value = 1;
		}
		else {
			value = 0;
	...
	public CacheModel<Article> toCacheModel() {
		...
		articleCacheModel.resourcePrimKey = getResourcePrimKey();
