...
import com.liferay.amf.newsletter.service.persistence.impl.constants.TSPersistenceConstants;
...
public class ArticlePersistenceImpl
	...
	public Article[] findByUuid_PrevAndNext(
		...
		Article article = findByPrimaryKey(resourcePrimKey);
	 ...
	 */
	@Override
	public List<Article> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(
	 ...
	 */
	@Override
	public List<Article> findByUuid_C(
	...
	public Article findByUuid_C_First(
		...
		Article article = fetchByUuid_C_First(
	...
	public Article fetchByUuid_C_First(
		...
		List<Article> list = findByUuid_C(
	...
	public Article findByUuid_C_Last(
		...
		Article article = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public Article[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, article, uuid, companyId, orderByComparator, true);

			array[1] = article;

			array[2] = getByUuid_C_PrevAndNext(
				session, article, uuid, companyId, orderByComparator, false);
	...
	protected Article getByUuid_C_PrevAndNext(
		Session session, Article article, String uuid, long companyId,
		OrderByComparator<Article> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public List<Article> findByGroupId(long groupId, int start, int end) {
	 ...
	 */
	@Override
	public List<Article> findByGroupId(
	...
	public Article findByGroupId_First(
		...
		Article article = fetchByGroupId_First(groupId, orderByComparator);
	...
	public Article fetchByGroupId_First(
		...
		List<Article> list = findByGroupId(groupId, 0, 1, orderByComparator);
	...
	public Article findByGroupId_Last(
		...
		Article article = fetchByGroupId_Last(groupId, orderByComparator);
	...
	public Article fetchByGroupId_Last(
		...
		List<Article> list = findByGroupId(
	...
	public Article[] findByGroupId_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroupId_PrevAndNext(
				session, article, groupId, orderByComparator, true);

			array[1] = article;

			array[2] = getByGroupId_PrevAndNext(
				session, article, groupId, orderByComparator, false);
	...
	protected Article getByGroupId_PrevAndNext(
		Session session, Article article, long groupId,
		OrderByComparator<Article> orderByComparator, boolean previous) {
	...
	public Article create(long resourcePrimKey) {
		...
		article.setNew(true);
		article.setPrimaryKey(resourcePrimKey);
