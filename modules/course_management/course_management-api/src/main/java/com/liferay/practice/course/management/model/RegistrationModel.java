...
/**
 * The base model interface for the Registration service. Represents a row in
 * the &quot;CourseManagement_Registration&quot; database table, with each
 ...
 * <code>com.liferay.practice.course.management.model.impl.RegistrationImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface RegistrationModel extends BaseModel<Registration>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a
	 * registration model instance should use the {@link Registration} interface
	 * instead.
	 */
