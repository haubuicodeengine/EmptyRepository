 ...
 * in
 * {@link com.liferay.practice.course.management.service.impl.CourseLocalServiceImpl}.
 * </p>
 *
...
public abstract class CourseLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * <code>CourseLocalService</code> via injection or a
	 * <code>org.osgi.util.tracker.ServiceTracker</code> or use
	 * <code>com.liferay.practice.course.management.service.CourseLocalServiceUtil</
	 * code>.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Course.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return coursePersistence.findWithDynamicQuery(dynamicQuery, start, end, orderByComparator);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] { CourseLocalService.class, IdentifiableOSGiService.class,
