...
public class CourseServiceSoap {
	...
	public static com.liferay.practice.course.management.model.CourseSoap addCourse(long groupId,
			...
			String[] descriptionMapValues, String[] lecturerMapLanguageIds, String[] lecturerMapValues, Long duration,
			int courseStatus, com.liferay.portal.kernel.service.ServiceContext serviceContext) throws RemoteException {
		...
		try {
			...
			com.liferay.practice.course.management.model.Course returnValue = CourseServiceUtil.addCourse(groupId,
					courseNameMap, descriptionMap, lecturerMap, duration, courseStatus, serviceContext);
	...
	public static Long[] getListCourseByUserId(long userId) throws RemoteException {

		try {
			java.util.List<Long> returnValue = CourseServiceUtil.getListCourseByUserId(userId);
