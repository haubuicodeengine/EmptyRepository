...
<body>
	<div class="container">
		<h1 class="text-title">${bookEdit == null ? "Add " : "Edit "}a
			book</h1>
		<form class="form"
			action="<%=request.getContextPath()%>/${bookEdit == null ? "
			addBook" : "editBook"}" method="POST">
			<input type="hidden" name="id" class="input-item"
			...
			<div class="form-group">
				<label class="text-label" for="book-name">Book name</label> <input
					...
					" : "error"}" placeholder="${error == null ? " Enter the book'sname " :error}">
			</div>
			<div class="form-group">
