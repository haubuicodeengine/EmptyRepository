...
<head>
<meta charset="UTF-8">
<title>Welcome to the book</title>
<style>
.container {
	width: 70%;
	margin: 0 auto;
...
<body>
	<div class="container">
		<a href="books" class="text-welcome">Welcome to my web application</a>

		<div class="form-group">
			<label class="text-label" for="author">Book Type</label> <select
				id="test">
		...
		jQuery.fn.extend({
			CreateMultiCheckBox : function(options) {
				...
				this.find("option").each(function() {
					...
					multiCheckBoxDetailBody.append("<div class='cont'><div><input type='checkbox' class='mulinput' value='" + val + "' /></div><div>"
						+ $(this).text()
						+ "</div></div>");
				});
